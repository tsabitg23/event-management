...
describe('EventService', () => {
  ...
  it('should return all event with pagination', async () => {
    ...
    jest.spyOn(eventRepository, 'findAndCount').mockResolvedValue([eventMockResult, eventMockResult.length]);
  ...
  it('should return error when event not found', async () => {
    ...
    await expect(service.getById(eventsData[0].id)).rejects.toThrowError('Event not found');
  });
